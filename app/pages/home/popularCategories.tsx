...
export function PopularSection() {
    ...
    return (
        <section className="pt-16 pb-8 relative overflow-hidden max-w-screen-2xl mx-auto px-4 sm:px-6">
            ...
            >
                {categoriesData?.map((category: CategoryData, index: number) => (
                    <Link key={category.id} href={`/order/${category.code}`}>
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
